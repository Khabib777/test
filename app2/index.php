...
echo ('город: '.$city['city']['name_ru'].'<br>');
echo ('city: '.$city['city']['name_en'].'<br>');
echo ('код города: '.$city['city']['id'].'<br>');
echo ('широта города: '.$city['city']['lat'].'<br>');
echo ('city долгота: '.$city['city']['lon'].'<br>');
echo ('страна: '.$city['country']['name_ru'].'<br>');
echo ('country: '.$city['country']['name_en'].'<br>');
echo ('country iso: '.$city['country']['iso'].'<br>');
echo ('код страны: '.$city['country']['id'].'<br>');
